...
class Categorie
{
     ...
     * @return Categorie
     */
    public function addAttributproduitattributproduit(\Odysseus\BackBundle\Entity\Attributproduit $attributproduitattributproduit)
    {
     ...
     * @param \Odysseus\BackBundle\Entity\Attributproduit $attributproduitattributproduit
     */
    public function removeAttributproduitattributproduit(\Odysseus\BackBundle\Entity\Attributproduit $attributproduitattributproduit)
    {
